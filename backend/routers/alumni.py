    ...
    with pd.ExcelWriter(output, engine='openpyxl') as writer:
        ...
        profile_data = {
            ...
            "Details": [
                ...
                full_profile.email,
                full_profile.gender,
                str(full_profile.birthdate) if full_profile.birthdate else "Not Set",
                full_profile.age
            ]
        }
        ...
        academic_data = {
            ...
            "Details": [
                full_profile.student_id or "Not Set",
                full_profile.course_name or "Not Set",
                full_profile.year_graduated or "Not Set",
                full_profile.gwa or "Not Set",
                full_profile.avg_prof_grade or "Not Set",
                full_profile.avg_elec_grade or "Not Set",
                full_profile.ojt_grade or "Not Set",
                "Yes" if full_profile.leadership_pos else "No",
                "Yes" if full_profile.act_member_pos else "No"
            ]
        }
        ...
        emp_data = {
            ...
            "Details": [
                full_profile.employment_status or "Not Set",
                full_profile.employment_sector or "Not Set",
                full_profile.salary_package or "0",
                full_profile.offers_received or "0"
            ]
        }
        pd.DataFrame(emp_data).to_excel(writer, sheet_name="Employment Status", index=False)
        
        # Sheet 4: Skills
        if full_profile.skills:

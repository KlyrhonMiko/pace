...
class CollegeDeptBatchCreate(BaseModel):
    ...
    items: List[CollegeDeptCreate] = Field(..., min_length=1, max_length=100, description="List of college departments to create (1-100 items)")
...
class CollegeDeptBatchUpdate(BaseModel):
    ...
    items: List[CollegeDeptBatchUpdateItem] = Field(..., min_length=1, max_length=100, description="List of college departments to update (1-100 items)")
...
class CollegeDeptBatchDelete(BaseModel):
    ...
    ids: List[str] = Field(..., min_length=1, max_length=100, description="List of college department IDs to delete (1-100 items)")
...
class CollegeDeptBatchRestore(BaseModel):
    ...
    ids: List[str] = Field(..., min_length=1, max_length=100, description="List of college department IDs to restore (1-100 items)")

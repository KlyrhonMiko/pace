                ...
                <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-8">
                    <div>
                        ...
                        <h1 className="text-4xl lg:text-5xl font-black tracking-tight mb-4">
                            Event <span className="text-emerald-400">Management</span>
                        </h1>
                        <p className="text-slate-300 text-lg max-w-xl leading-relaxed">
                            Create, update, and manage professional events across the platform.
                            Maintain high-quality standards for our alumni community.
                        </p>
                    </div>
                    ...
                    <div className="flex gap-4">
                        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 min-w-[160px] hover:bg-white/10 transition-colors">
                            ...
                            <div className="text-[11px] font-bold text-emerald-400/60 uppercase mt-1">Live Events</div>
                        </div>
                    </div>
                </div>
            </div>

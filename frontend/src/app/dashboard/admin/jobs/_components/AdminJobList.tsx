                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-base font-bold text-gray-900">
                            {isLoading ? "Searching..." : `Platform Job Postings`}
                        </h2>
                ...
                <table className="w-full text-left border-collapse min-w-[700px]">
                    <thead>
                        <tr className="bg-slate-50/30 border-b border-slate-100">
                            <th className="px-5 py-3 text-xs font-bold text-slate-500 uppercase tracking-wider w-[45%]">Job Details</th>
                            <th className="px-5 py-3 text-xs font-bold text-slate-500 uppercase tracking-wider w-[25%]">Type & Location</th>
                            <th className="px-5 py-3 text-xs font-bold text-slate-500 uppercase tracking-wider w-[15%]">Salary</th>
                            <th className="px-5 py-3 text-xs font-bold text-slate-500 uppercase tracking-wider text-right w-[15%]">Actions</th>
                        </tr>
                    </thead>
                            ...
                            <tr>
                                <td colSpan={4} className="px-6 py-32 text-center bg-slate-50/20">
                                    <div className="flex flex-col items-center gap-4">
                                        ...
                                        <Button variant="link" onClick={clearFilters} className="text-emerald-700 font-bold h-auto p-0">
                                            Clear all filters
                                        </Button>
                                    </div>
                                </td>
                                    ...
                                    >
                                        ...
                                        <td className="px-5 py-4 text-right">
                                            <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                                ...
                                                >
                                                    {job.isActive ? <EyeOff className="h-3.5 w-3.5" /> : <Eye className="h-3.5 w-3.5" />}
                                                </Button>
                                                <Button
                                                    variant="ghost"
                                                    size="icon"

...
export default function StatsGrid() {
    return (
        <div className="grid gap-4 sm:grid-cols-2 h-full">
            {/* Profile Views */}
            <div className="group relative rounded-2xl bg-white border border-gray-100 p-5 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-700/5 hover:-translate-y-0.5 h-full flex flex-col">

...
import { Zap, ChevronRight, Users, PlusCircle, Building, BarChart3 } from "lucide-react";
...
const actions = [
    ...
    },
    {
        ...
        description: "Review and process candidates",
    ...
    },
    {
        ...
        description: "Update your employer brand",
...
export default function EmployerQuickActions() {
    return (
        <div className="group/card relative rounded-2xl bg-white border border-gray-100/80 shadow-sm transition-all duration-500 hover:shadow-xl hover:shadow-gray-200/20 hover:border-gray-200/80 overflow-hidden flex flex-col">
            {/* Header */}

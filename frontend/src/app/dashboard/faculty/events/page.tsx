                    ...
                    <div className="flex gap-4">
                        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 min-w-[160px] hover:bg-white/10 transition-colors">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <span className="text-[10px] font-bold text-emerald-200/60 uppercase tracking-widest">Scheduled</span>
                            </div>
                            <div className="text-3xl font-black">12</div>
                            <div className="text-[11px] font-bold text-teal-300/60 uppercase mt-1">Pending Sync</div>
                        </div>
                    </div>
                </div>
            </div>

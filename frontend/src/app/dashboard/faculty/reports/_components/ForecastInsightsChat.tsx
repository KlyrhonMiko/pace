...
import { useForecastAIStore } from "./forecast-ai-store";
...
export default function ForecastInsightsChat({ forecastData }: { forecastData: ForecastData }) {
    const { isOpen, setIsOpen, initialQuery, clearQuery } = useForecastAIStore();
    const [isMinimized, setIsMinimized] = useState(false);
    const [messages, setMessages] = useState<Message[]>([
        {
            id: "welcome",
            role: "assistant",
            content: "Hi! I'm the P.A.C.E. Forecast Assistant. I can help you understand the employment trends, statistical predictions, and institutional implications. What would you like to know?"
        }
    ]);
        ...
        >
            ...
            >
                <div className="flex items-center gap-2.5">
                    ...
                    <div>
                        <h3 className="font-bold text-sm leading-tight">AI Forecast Insights</h3>
                        {!isMinimized && <p className="text-[10px] text-emerald-100 font-medium">Ask me about the employment trends</p>}
                    </div>
                </div>
                    ...
                    <div className="p-3 bg-white border-t border-gray-100">
                        <form onSubmit={handleSubmit} className="relative flex items-center">
                            <input
                                ...
                                placeholder="Ask about forecast insights..."

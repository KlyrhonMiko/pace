...
function StepIndicator({ currentStep, role }: { currentStep: number; role?: "Alumni" | "Employer" | null }) {
    const steps = role === "Employer" ? [
        { id: 1, name: "Account", icon: <Settings className="w-4 h-4" /> },
        { id: 2, name: "Company", icon: <Briefcase className="w-4 h-4" /> },
        { id: 3, name: "Verify", icon: <ShieldCheck className="w-4 h-4" /> },
    ] : [
        { id: 1, name: "Account", icon: <Settings className="w-4 h-4" /> },
...
export default function RegisterPage() {
    ...
    const [role, setRole] = useState<"Alumni" | "Employer" | null>(null);
                ...
                <div className="max-w-2xl w-full bg-white rounded-[2rem] shadow-xl shadow-slate-200/60 border border-slate-100 overflow-hidden relative">
                    ...
                    <div className="relative z-10 p-8 md:p-12">
                        {role === null ? (
                            <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500 py-8">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                                    ...
                                    <button
                                        ...
                                        className="flex flex-col items-center justify-center gap-4 p-8 rounded-2xl border-2 border-slate-100 hover:border-blue-500 hover:bg-blue-50 transition-all group focus:outline-none focus:ring-4 focus:ring-blue-500/20"
                                    >
                            ...
                            <>
                                <StepIndicator currentStep={step} role={role} />
                                ...
                                <form onSubmit={handleSubmit} className="mt-12">
                                    ...
                                    {step === 2 && role === "Employer" && (
                                        <FormSection title="Company Information" subtitle="Tell us about your organization">
                                            <InputField label="Company Name" value={employerInfo.companyName}
                                                onChange={(v) => setEmployerInfo(p => ({ ...p, companyName: v }))} placeholder="Acme Corp" required className="md:col-span-2" />
                                            ...
                                            <InputField label="Your Position / Title" value={employerInfo.position}
                                                onChange={(v) => setEmployerInfo(p => ({ ...p, position: v }))} placeholder="HR Manager" className="md:col-span-2" />
                                        </FormSection>
                                    )}
                                    ...
                                    <div className="mt-12 pt-8 border-t border-slate-100 flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            {/* Verification button is in the OTP section above */}
                                        </div>
                                    </div>
                                </form>
                            </>
